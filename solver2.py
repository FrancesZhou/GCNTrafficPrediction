		...
		with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
			...
			for e in range(self.n_epochs):
				...
				for i in xrange(num_train_batches):
					...
					#print i
					#t1 = time.time()
					x, f, ee, y = train_loader.next_batch_for_train(i*self.batch_size, (i+1)*self.batch_size)
				...
				if e % 1 == 0:
					...
					for i in xrange(num_test_batches):
						...
						x, f, ee, y = test_loader.next_batch_for_train(i * self.batch_size, (i + 1) * self.batch_size)
